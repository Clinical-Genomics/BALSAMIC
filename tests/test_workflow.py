...
def test_workflow_tumor_normal(tumor_normal_config, sentieon_install_dir, sentieon_license):
...
def test_workflow_qc(tumor_normal_config, tumor_only_config, sentieon_install_dir, sentieon_license):
    # GIVEN a sample config dict and snakefile
    workflow = 'qc'
    snakefile = get_snakefile(workflow)
...
def test_workflow_sentieon(tumor_normal_wgs_config, tumor_only_wgs_config, sentieon_install_dir, sentieon_license):
    # GIVEN a sample config dict and snakefile
