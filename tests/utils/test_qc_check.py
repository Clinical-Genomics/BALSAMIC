...
from BALSAMIC.utils.qc_check import write_output
...
def test_check_qc_criteria_and_output_csv():
    ...
    # THEN check if the output df has 3 indexes and if csv-file exists
