...
def test_extend_bedfile(
    ...
    minimum_region_size = WORKFLOW_PARAMS["expand_short_bedregions"]["minimum_region_size"]
    ...
    result: Result = cli_runner.invoke(
        extend_bedfile, ["--min-region-size",  minimum_region_size, bedfile_path.as_posix(), extended_bed_path.as_posix()]
    )
