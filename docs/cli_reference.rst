...
BALSAMIC (**version** = 4.2.3) is using Click. This section covers the CLI reference for BALSAMIC.
...
::
  ...
  Usage: balsamic [OPTIONS] COMMAND [ARGS]...
    ...
    BALSAMIC 4.2.3: Bioinformatic Analysis pipeLine for SomAtic MutatIons in
    Cancer
