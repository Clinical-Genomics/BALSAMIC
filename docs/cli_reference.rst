...
BALSAMIC (**version** = 5.0.0) is using Click. This section covers the CLI reference for BALSAMIC.
...
::
  ...
  Usage: balsamic [OPTIONS] COMMAND [ARGS]...
    ...
    BALSAMIC 5.0.0: Bioinformatic Analysis pipeLine for SomAtic MutatIons in
    Cancer
