...
BALSAMIC (**version** = 4.2.4) is using Click. This section covers the CLI reference for BALSAMIC.
...
::
  ...
  Usage: balsamic [OPTIONS] COMMAND [ARGS]...
    ...
    BALSAMIC 4.2.4: Bioinformatic Analysis pipeLine for SomAtic MutatIons in
    Cancer
