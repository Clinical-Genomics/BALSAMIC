...
BALSAMIC (**version** = 6.1.0) is using Click. This section covers the CLI reference for BALSAMIC.
...
::
  ...
  Usage: balsamic [OPTIONS] COMMAND [ARGS]...
    ...
    BALSAMIC 6.1.0: Bioinformatic Analysis pipeLine for SomAtic MutatIons in
    Cancer
