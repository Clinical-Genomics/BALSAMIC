...
BALSAMIC (**version** = 5.0.1) is using Click. This section covers the CLI reference for BALSAMIC.
...
::
  ...
  Usage: balsamic [OPTIONS] COMMAND [ARGS]...
    ...
    BALSAMIC 5.0.1: Bioinformatic Analysis pipeLine for SomAtic MutatIons in
    Cancer
