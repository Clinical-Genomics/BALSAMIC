...
SLEEP_BEFORE_START = 200

WORKFLOW_PARAMS = {
    "common": {
        "pcr_model": "NONE",
        "align_header": "'@RG\\tID:{wildcards.fastq_pattern}\\tSM:{params.sample_type}\\tPL:ILLUMINA'",
        "min_mapq": "20",
        "picard_fixmate": " ".join(
            [
                "-ADD_MATE_CIGAR true",
    ...
    "umicommon": {
        "align_header": "'@RG\\tID:{wildcards.fastq_pattern}\\tSM:{params.sample_type}\\tLB:TargetPanel\\tPL:ILLUMINA'",
