...
class VarDictFilters:
    common_hard_filters = [
        ...
        Filter(filter_name="pSTD", Description="Position in Reads has STD of 0"),
    ...
    TN_hard_filters = common_hard_filters + [
        Filter(filter_name="Bias", Description="Strand Bias"),
        Filter(
            filter_name="DIFF0.2",
        ...
        Filter(filter_name="P0.9", Description="Not significant with p-value > 0.9"),
        Filter(filter_name="d5", Description="Total Depth < 5"),
        Filter(filter_name="v3", Description="Var Depth < 3"),
    ]
