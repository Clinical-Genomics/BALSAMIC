...
REFERENCE_FILES = {
    ...
    "canfam3": {
        "reference_genome": {
            "url": "http://hgdownload.cse.ucsc.edu/goldenPath/canFam3/bigZips/canFam3.fa.gz",
            "file_type": "fasta",
            "gzip": True,
        ...
        "refgene_txt": {
            "url": "http://hgdownload.cse.ucsc.edu/goldenPath/canFam3/database/refGene.txt.gz",
            "file_type": "text",
            "gzip": True,
            "genome_version": "canfam3",
            "output_file": "refGene.txt",
        ...
        "refgene_sql": {
            "url": "http://hgdownload.cse.ucsc.edu/goldenPath/canFam3/database/refGene.sql",
            "file_type": "text",
            "gzip": False,
            "genome_version": "canfam3",
            "output_file": "refGene.sql",
        ...
        "genome_chrom_size": {
            "url": "https://hgdownload.soe.ucsc.edu/goldenPath/canFam3/bigZips/canFam3.chrom.sizes",
            "file_type": "text",
            "gzip": False,
            "genome_version": "canfam3",
